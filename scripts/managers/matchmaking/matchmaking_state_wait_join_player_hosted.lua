...
MatchmakingStateWaitJoinPlayerHosted.on_enter = function (self, state_context)
	...
	local match_started = self._lobby_client:lobby_data("match_started") == "true"
...
MatchmakingStateWaitJoinPlayerHosted._sync_player_data = function (self)
	...
	self._network_transmit:send_rpc("rpc_matchmaking_sync_player_data", host, peer_id, name, profile_id, career_id, slot_data.slot_frame, slot_data.slot_melee, slot_data.slot_ranged, fake_party_id, versus_level, do_full_sync)
end
