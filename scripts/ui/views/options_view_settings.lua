...
local versus_settings_definition = {
	...
	{
		text = "settings_view_header_versus_custom_game",
		widget_type = "title"
	},
	{
		setting_type = "versus_settings",
		setting_name = "difficulty",
		widget_type = "stepper",
		options = {
			{
				value = "easy",
				text = Localize("difficulty_easy")
			},
			{
				value = "normal",
				text = Localize("difficulty_normal")
			},
			{
				value = "hard",
				text = Localize("difficulty_hard")
			}
		}
	},
	{
		...
		options = {
			{
				value = "team_hammers",
				text = Localize("versus_team_name_hammers")
			},
			{
				value = "team_skulls",
				text = Localize("versus_team_name_skulls")
			},
			{
				value = "random",
				text = Localize("inventory_screen_random_tooltip")
			}
		}
	},
	{
		setting_type = "versus_settings",
		setting_name = "healing_item",
		widget_type = "stepper",
		options = {
			{
				value = "lowest",
	...
	{
		setting_type = "versus_settings",
		setting_name = "career_changing_enabled",
		widget_type = "stepper",
		options = {
			{
				value = true,
	...
	{
		setting_type = "versus_settings",
		setting_name = "custom_loadout_enabled",
		widget_type = "stepper",
		options = {
			{
				value = true,
	...
	},
	{
		...
		options = {
			...
			{
				value = "in_sight",
				text = Localize("menu_settings_in_sight")
			},
			{
				value = "off",
				text = Localize("menu_settings_off")
	...
	},
	{
		...
		options = {
			...
			{
				value = "inf",
				text = Localize("menu_settings_infinite")
			}
		}
	},
	{
	...
	{
		setting_type = "versus_settings",
		setting_name = "gutter_runner_enabled",
		widget_type = "stepper",
		options = {
			{
				value = true,
	...
	{
		setting_type = "versus_settings",
		setting_name = "packmaster_enabled",
		widget_type = "stepper",
		options = {
			{
				value = true,
	...
	{
		setting_type = "versus_settings",
		setting_name = "globadier_enabled",
		widget_type = "stepper",
		options = {
			{
				value = true,
	...
	{
		setting_type = "versus_settings",
		setting_name = "ratling_gunner_enabled",
		widget_type = "stepper",
		options = {
			{
				value = true,
	...
	{
		setting_type = "versus_settings",
		setting_name = "warpfire_thrower_enabled",
		widget_type = "stepper",
		options = {
			{
				value = true,
	...
	{
		setting_type = "versus_settings",
		setting_name = "bile_troll_enabled",
		widget_type = "stepper",
		options = {
			{
				value = true,
	...
	{
		setting_type = "versus_settings",
		setting_name = "special_choice_amount",
		widget_type = "stepper",
		options = {
			{
				text = "0",
