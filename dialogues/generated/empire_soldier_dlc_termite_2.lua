return function ()
	...
	define_rule({
		response = "pes_power_cavern_disable_generator_complete_b",
		name = "pes_power_cavern_disable_generator_complete_b",
		probability = 1,
		criterias = {
			{
				"query_context",
	...
	add_dialogues({
		...
		pes_power_cavern_disable_generator_complete_b = {
			randomize_indexes_n = 0,
			face_animations_n = 2,
			database = "empire_soldier_dlc_termite_2",
			sound_events_n = 2,
			...
			localization_strings = {
				[1] = "pes_power_cavern_disable_generator_complete_b_01",
				[2] = "pes_power_cavern_disable_generator_complete_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pes_power_cavern_disable_generator_complete_b_01",
