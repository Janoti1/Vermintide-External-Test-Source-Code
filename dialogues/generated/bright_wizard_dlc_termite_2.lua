return function ()
	...
	define_rule({
		response = "pbw_power_cavern_disable_generator_complete_b",
		name = "pbw_power_cavern_disable_generator_complete_b",
		probability = 1,
		criterias = {
			{
				"query_context",
	...
	add_dialogues({
		...
		pbw_power_cavern_disable_generator_complete_b = {
			randomize_indexes_n = 0,
			face_animations_n = 2,
			database = "bright_wizard_dlc_termite_2",
			sound_events_n = 2,
			...
			localization_strings = {
				[1] = "pbw_power_cavern_disable_generator_complete_b_01",
				[2] = "pbw_power_cavern_disable_generator_complete_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_power_cavern_disable_generator_complete_b_01",
		...
		pbw_power_escape_monster_reveal_a = {
			...
			localization_strings = {
				...
				[2] = "pbw_power_escape_monster_reveal_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_power_escape_monster_reveal_a_01",
