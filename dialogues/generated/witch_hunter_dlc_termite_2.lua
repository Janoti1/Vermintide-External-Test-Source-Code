return function ()
	...
	define_rule({
		response = "pwh_power_cavern_disable_generator_complete_b",
		name = "pwh_power_cavern_disable_generator_complete_b",
		probability = 1,
		criterias = {
			{
				"query_context",
	...
	add_dialogues({
		...
		pwh_power_cavern_disable_generator_complete_b = {
			randomize_indexes_n = 0,
			face_animations_n = 2,
			database = "witch_hunter_dlc_termite_2",
			sound_events_n = 2,
			...
			localization_strings = {
				[1] = "pwh_power_cavern_disable_generator_complete_b_01",
				[2] = "pwh_power_cavern_disable_generator_complete_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_power_cavern_disable_generator_complete_b_01",
		...
		pwh_power_escape_monster_reveal_a = {
			...
			localization_strings = {
				[1] = "pwh_power_escape_monster_reveal_a_01",
				[2] = "pwh_power_escape_monster_reveal_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_power_escape_monster_reveal_a_01",
